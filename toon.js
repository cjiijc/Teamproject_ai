class Toon{
    ...
    */
        ...
        constructor(gamefont, imglist){ //gamefont와 관련된 부분은 잘 모르겠음.
            this.gamefont = gamefont;
            this.myTimer = new Timer(5000 + 1000);
            this.img = imglist;
      ...
      **/ background(0);
          ...
          tint(255,this.tint_calc(5000 + 1000, this.myTimer.getRemainingTime()));
          //투명도를 매 프레임마다 계산한다.
          if (this.counter < this.len){ 
          // array index외의 것을 탐색하여 오류가 발생하는 것을 막기 위함
            this.img[this.counter].resize(400,400);
          ...
          if (keyIsPressed) {
            if(this.myTimer.getRemainingTime() < 5000 + 800){
