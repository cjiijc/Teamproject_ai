...
function preload(){
  ...
  soundEffects['trueBGM'] = loadSound('./assets/sound/true.mp3');
...
function keyPressed() {
  ...
  //메인 스테이지
  if ((currentScene == 'Main2') && ((mainstage.getLevel() < 7)) && (keyCode != 27) && (currentScene != 'END_TOON')){
  ...
  } else if ((currentScene == 'Main2') && ((mainstage.getLevel() >= 7)) && (keyCode != 27) && (currentScene != 'END_TOON')) { //fever 상황
    mFeverEffect();
