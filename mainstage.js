class MainStage {
    ...
    displayFeedback(){
        if (this.level < 7){
            if ((this.isEnter)&&(this.feverEnter == false)){ // enter키 입력받기
                textSize(20);
                // textAlign(CENTER);
            ...
            } else if (this.feverEnter){
                textSize(22);
                // textAlign(CENTER);
                textFont(this.gamefont);
                fill(255);
                stroke(255);
                text('ENTER TO SUBMIT', 322, height-195);
            }
            ...
            if (this.feedback.length != 0) {
                ...
                fill(0);
                stroke(0);
                text(strFeed, width/2 + 65, height - 75);
            }
        } else { //fever
            textSize(23);
            textAlign(CENTER);
            ...
            fill('#E61673');
            stroke('#E61673');
            text("FEVER!!", width/2+65, height - 75);
        }
    }
    ...
    endFever(){
        if (this.level >= 7){
            ...
            this.player.playerLife(this.life);
            this.feverEnter = true;
        }   
    }

    getFenter(){
        return this.feverEnter;
    }
    ...
    displaySudden(suddenPage){
        this.displayTimer();
        if (suddenPage == 0){
        background(this.sudden[suddenPage]);
        } else if (suddenPage > 0){
    ...
    displayInfo(){
        switch (this.level){
            case 1:
                ...
                textFont(this.gamefont);
                fill('#2EA7E0');
                text("press 'D' or 'F'", 240, height-110);
                break;
            case 2:
                textSize(20);
                // textAlign(CENTER);
            ...
            case 3:
                ...
                textFont(this.gamefont);
                fill('#2EA7E0');
                text("Click or Not", 230, height-110);
                break;
            case 4:
                textSize(20);
                // textAlign(CENTER);
                textFont(this.gamefont);
                fill('#2EA7E0');
                text("강아지도 음식도 아니라면, press 'Space'", 348, height-110);
                break;
            case 5:
                textSize(20);
                // textAlign(CENTER);
            ...
            case 7:
                ...
                fill('#E61673');
                stroke('#E61673');
                text("Press any key!", 322, height-190);
                break;
            case 8:
                noTint();
                textSize(22);
